...
class ForgetPasswordController extends Controller
{
    ...
    public function sendOtp(Request $request)
    {
        ...
        if($reset && Carbon::parse($reset->created_at)->addSeconds(60)->isFuture()){
            return $this->errorApi('Please wait 60 seconds before requesting a new OTP',429);
        }
        ...
        $admin->notify(new ResetPasswordNotification($otp));
        return $this->successApi(null,'OTP sent successfully');
    }
